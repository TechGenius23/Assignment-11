        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-16 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 bg-gray-800 dark:bg-gray-100 text-gray-100 dark:text-gray-800">
            <div className="flex flex-col justify-between">
                <div className="space-y-2">
                    ...
                    <div className="text-gray-400 dark:text-gray-600">Just ask your question</div>
                </div>
            ...
            <form noValidate="" className="space-y-6">
                <div>
                    ...
                    <input id="name" type="text" placeholder="" className="w-full p-3 rounded bg-white-500 dark:bg-gray-100" />
                </div>
                <div>
                    <label htmlFor="email" className="text-sm">Email</label>
                    <input id="email" type="email" className="w-full p-3 rounded bg-white-500  dark:bg-gray-100" />
                </div>
                <div>
                    <label htmlFor="message" className="text-sm">Message</label>
                    <textarea id="message" rows="3" className="w-full p-3 rounded bg-white-500  dark:bg-gray-100"></textarea>
                </div>
